...
public class ExtentReportManager {
    ...
    public static synchronized void initializeExtentReport() {
        initializeExtentReport("ExtentReport");
    }
    
    public static synchronized void initializeExtentReport(String reportName) {
        if (extentReports == null) {
            String timestamp = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
            String reportPath = System.getProperty("user.dir") + "/test-output/" + reportName + "_" + timestamp + ".html";

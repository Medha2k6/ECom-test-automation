	 ...
	 @Test(dataProvider = "dp")
	    public void verifyUICases(Integer n, String s) {
	         ...
	         try {
	             ...
	             test.fail("The cart page is NOT displayed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("The login/signup page is NOT displayed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	        	 ...
	        	 String path = ScreenshotUtilities.captureScreenshot(driver, "TestCasesPage_Fail");
	             test.fail("The test cases page is NOT displayed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("The API testing page is NOT displayed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("The video tutorials page is NOT displayed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("The contact us page is NOT displayed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         
	         // Navigate to Automation Exercise homepage
	         ...
	         try {
	             ...
	             test.fail("Homepage logo navigation failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             String path = ScreenshotUtilities.captureScreenshot(driver, "EmailSub_Fail");
	             test.fail("Error in email subscription with valid email: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             String path = ScreenshotUtilities.captureScreenshot(driver, "BrandFilter_Fail");
	             test.fail("Brand filter check failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Expanding category section failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             String path = ScreenshotUtilities.captureScreenshot(driver, "SearchBar_Fail");
	             test.fail("Search bar test failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Add to cart button test failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Go to top button test failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("View product button test failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Women category sections test failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Men category sections test failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Kids category sections test failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("View Cart button test failed: " + e.getMessage(),MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	        		...
	        		String path = ScreenshotUtilities.captureScreenshot(driver, "EmailSub_Fail");
	        	    test.fail("Invalid email was incorrectly accepted (expected error alert, but not found).",MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	        	}
	      ...
	      // TC_Product_21 - Page scroll bar
	         try {
	             ...
	             test.fail("Page scroll test failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Special offer section verification failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Promo banner presence verification failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             String path = ScreenshotUtilities.captureScreenshot(driver, "TC_Product_24_Fail");
	             test.fail("Blank email subscription validation failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             String path = ScreenshotUtilities.captureScreenshot(driver, "TC_Product_25_Fail");
	             test.fail("Invalid product search verification failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             test.fail("Product details verification failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             String path = ScreenshotUtilities.captureScreenshot(driver, "TC_Product_27_Fail");
	             test.fail("Maximum character limit test failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
	         ...
	         try {
	             ...
	             String path = ScreenshotUtilities.captureScreenshot(driver, "TC_Product_28_Fail");
	             test.fail("Special characters search test failed: " + e.getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(path).build());
	         }
